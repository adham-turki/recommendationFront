...
const Search = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.1.136:8089/profiles/search?interests=tech');
      if (!response.ok) {
      ...
      'Business','animal']}
          ...
          <div className="relative p-4 bg-[#e6e2eb] min-h-screen">
            {loading ? (
              ...
              <p className="text-center text-[#352872]">Search for profiles to see results.</p>
            )}
          </div>
        </main>
