...
const Login = () => {
  ...
  const handleLogin = (provider) => {
    if(provider == "google"){
      ...
      window.location.href = 'http://192.168.1.123:2505/oauth2/authorization/google';
    }else{
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#fff] bg-opacity-0 p-8 rounded-lg shadow-2xl max-w-sm w-full flex flex-col items-center ml-40">
        ...
        {/* Sign up link */}
        <p className="txt text-sm text-[#fff] type3 mt-4">
           Don't have an account?{' '}
          <a href="/" className="txt text-[#fff] font-bold hover:underline">
            Sign up
          </a>
        </p>
      </div>
